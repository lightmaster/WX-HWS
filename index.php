...
<span class="yearpopup">  <a alt="Statistics temperature" title="Statistics temperature" href="tempalmanac.php" data-featherlight="iframe" > <?php echo $chartinfo?> Statistics </a></span>
...
<?php if ($position6=='forecast3ds.php' || ($apikey!= '11111111111111' && ($position6=='forecast3wu.php' || $position6=='forecast3wularge.php'))) {echo ' <span class="yearpopup"><a alt="Hourly Forecast" title="Hourly Forecast" href="forecastdshour.php" data-featherlight="iframe">&nbsp;'. $chartinfo. " Hourly Forecast</a></span>";}?></span>
  ...
  <span class="monthpopup">  <a href="cam.php" data-featherlight="iframe" ><?php echo $chartinfo?> <?php echo 'Web Cam'; ?></a>
...
<div class="weather-container"><div class="weather-item"><div class="chartforecast">
<span class="yearpopup">  <a alt="windspeed Statistics" title="windspeed Statistics" href="windalmanac.php" data-featherlight="iframe" ><?php echo $chartinfo?> Statistics </a></span>
...
<span class="todaypopup"> <a alt="today windspeed" title="today windspeed" href="<?php echo $chartsource ;?>/todaywindspeedgust.php" data-featherlight="iframe" ><?php echo $menucharticonpage?> <?php echo $lang['Today']; ?> </a></span>
  ...
  <div class="weather-item"><div class="chartforecast" >
  <span class="yearpopup">  <a alt="barometer Statistics" title="barometer Statistics" href="barometeralmanac.php" data-featherlight="iframe" ><?php echo $chartinfo?> Statistics</a></span>
...
<div class="weather-container"><div class="weather-item"><div class="chartforecast" >
<span class="yearpopup">  <a alt="Statistics rainfall" title="Statistics rainfall" href="rainfallalmanac.php" data-featherlight="iframe" ><?php echo $chartinfo?> Statistics </a></span>
...
<?php if ($position12=='weather34uvsolar.php') {echo ' <span class="yearpopup"><a alt="UV Statistics" title="UV Statistics" href="uvalmanac.php" data-featherlight="iframe">&nbsp;'. $chartinfo. " UV Statistics </a></span>";}?>
<?php if ($position12=='weather34uvsolar.php') {echo '<span class="yearpopup"> <a alt="Solar Statistics" title="Solar Statistics" href="solaralmanac.php" data-featherlight="iframe">'. $chartinfo. " Solar Statistics </a></span>";}?>
...
<?php if ($position12=='solaruvds.php') {echo ' <span class="yearpopup"><a alt="Solar Statistics" title="Solar Statistics" href="solaralmanac.php" data-featherlight="iframe">'. $chartinfo. " Solar Statistics </a></span>";}?>
...
<?php if ($position12=='solaruvwu.php') {echo ' <span class="yearpopup"><a alt="Solar Statistics" title="Solar Statistics" href="solaralmanac.php" data-featherlight="iframe">'. $chartinfo. " Solar AStatistics </a></span>";}?>
...
<?php if ($positionlastmodule=='weather34uvsolar.php') {echo ' <span class="yearpopup"><a alt="UV Statistics" title="UV Statistics" href="uvalmanac.php" data-featherlight="iframe">&nbsp;'. $chartinfo. " UV Statistics </a></span>";} ?>
<?php if ($positionlastmodule=='weather34uvsolar.php') {echo '<span class="yearpopup"> <a alt="Solar Statistics" title="Solar Statistics" href="solaralmanac.php" data-featherlight="iframe">'. $chartinfo. " Solar Statistics </a></span>";}?>
...
<?php if ($positionlastmodule=='solaruvds.php') {echo ' <span class="yearpopup"><a alt="Solar Statistics" title="Solar Statistics" href="solaralmanac.php" data-featherlight="iframe">'. $chartinfo. " Solar Statistics </a></span>";}?>
...
<?php if ($positionlastmodule=='solaruvwu.php') {echo ' <span class="yearpopup"><a alt="Solar Statistics" title="Solar Statistics" href="solaralmanac.php" data-featherlight="iframe">'. $chartinfo. " Solar Statistics </a></span>";}?>
...
<?php echo $mbplatform;?>-(<value><maxred><?php echo $weather["swversion"];echo "</maxred>"?></value>)&nbsp;
<?php echo $info."&nbsp;".$weatherhardware;?></div> 
<div class=footertext><?php echo $github;?>&nbsp;<?php echo "WeeWX Version Repository at";?>&nbsp;<a href="https://github.com/steepleian/WX-HWS" title="https://github.com/steepleian/WX-HWS" target="_blank"><?php echo "Github" ;?>  &nbsp; <img src="img/flags/<?php echo $flag ;?>.svg" width="20px" ></div>  
