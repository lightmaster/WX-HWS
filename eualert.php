...
if ($alertlevel=='Yellow' && $alerttype=='Wind') {$warnimage="wy.jpg";$bgcolor="yellow";}
else if ($alertlevel=='Orange' && $alerttype=='Wind') {$warnimage="wo.jpg";$bgcolor="orange";}
else if ($alertlevel=='Red' && $alerttype=='Wind') {$warnimage="wr.jpg";$bgcolor="red";}
...
else if ($alertlevel=='' && $alerttype=='')   {$warnimage="npa.jpg";$bgcolor="#99ff99";$warnTxt="No particular awareness of weather required";$alertissued="";$alertexp="";$from = "";$until = "";$level = ""; }
